function [Y] = expected_interpacket_fifo(N, mu, nu, b)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                         %
%                   function: expected_interpacket_fifo                   %
%           author: Federico Chiariotti (chiariot@dei.unipd.it)           %
%                             license: GPLv3                              %
%                                                                         %
%                                                                         %
%                                                                         %
% Computes the expected time between two consecutive successful frames in %
% the FIFO system                                                         %
%                                                                         %
% Inputs:                                                                 %
...
%                                                                         %
% Outputs:                                                                %
% -Y:   the expected interpacket time [scalar]                            %
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for state = valid
    for next_state = valid
        for med_state = valid
            Y = Y + mult(state) * zeta(state, med_state) * success(next_state) * G(med_state, next_state) * sum(nu);
        end
    end
end
