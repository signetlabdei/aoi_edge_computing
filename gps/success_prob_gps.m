function [sigma] = success_prob_gps(N, b, T)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                         %
%                       function: success_prob_gps                        %
...
% batch with a given index in the GPS system                              %
%                                                                         %
% Inputs:                                                                 %
...
for state = valid
    if (steady(state) > 0)
        sigma = sigma + steady(state) * success_prob_state_gps(N, state, T);
    end
end